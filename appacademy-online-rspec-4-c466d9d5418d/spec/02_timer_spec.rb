...
describe "Timer" do
  ...
  describe "#time_string" do
    it "should display 0 seconds as 00:00:00" do
      # This test will call the seconds setter method, Timer#seconds=(num)
      @timer.seconds = 0

      # This test will see if the return value of Timer#time_string is
      # equal to the string "00:00:00"
